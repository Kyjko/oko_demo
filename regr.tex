...
\end{tikzpicture}
\end{center}
A $\ebeta$ varianciája formulában szereplő $\sigma^2$ hibavariancia maga is becslésre szorul, ennek $\hat{\sigma}^2$ torzítatlan becslése a tényleges $\pmb{e}$ hibatagokkal számolható:
\[
	\hat{\sigma}^2 = \frac{\pmb{e}^T\pmb{e}}{n-p}
\]
