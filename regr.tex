...
\begin{document}
	...
	\subsection{*Mátrixok szinguláris értékei, SVD}
	...
	\]
	hibavektorokkal megbecsüljük $\widehat{\pmb{\Sigma}}$ hibavariancia-kovariancia mátrixot:
	\[
		\widehat{\sigma^2} = \frac{1}{n-p}\pmb{e}^T\pmb{e}
	\]
	\[
		\widehat{\pmb{\Sigma}} = 
		\begin{bmatrix}
